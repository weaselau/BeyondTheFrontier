...
export default async function Dayz() {
    ...
    const _message: Message = _channel.messages.cache.get('1069895987725869066') || await _channel.messages.fetch('1069895987725869066')

    Query('dayz', 'beyondthefrontier.au', 2304)
    .then((data: any) => {
